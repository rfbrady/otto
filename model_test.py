...
if __name__ == "__main__":
    ...
    if model_selection == "LinearSVC":
        ...
        #for predicted in model.df.sdg_codes:
        #    for actual in model.df.sdg_codes:
        #        print(predicted)
        #        print(actual)
        #        if predicted != actual and conf_mat[actual, predicted] >= 10:
        #            print("'{}' predicted as '{}' : {} examples.".format(actual, conf_mat[actual, predicted]))
        #            display(df.loc[indices_test[(y_test == actual) & (y_pred == predicted)]][['sdg_codes', 'corpus']])
        #            print('')
